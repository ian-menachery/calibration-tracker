...
- **Phase 5 (Kalshi cross-venue):** `markets.venue` column; `kalshi/` module (no signing/`cryptography`); `kalshi-discover`, `kalshi-fetch-candles`, `cross-venue`. Finding: Polymarket's sports FLB (b=0.834 [0.729,0.941] @24h) does **not** replicate on Kalshi (b=0.962 [0.824,1.099], n=2,262 — CI includes 1). Matched politics/geopolitics sweep is deferred (Kalshi fragments those into thousands of series).
